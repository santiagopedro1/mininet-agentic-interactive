...
from tools.net_management import add_host_tool, add_switch_tool, add_link_tool, remove_node_tool, deploy_topology_tool, list_topology_tool
...
def make_network_manager_agent(model):
    return Agent(
        ...
        model=model,
        use_json_mode=True,
        tools=[add_host_tool, add_switch_tool, add_link_tool, remove_node_tool, deploy_topology_tool, list_topology_tool],
        instructions=[
